...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stone-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11984&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stone-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stone` can be installed with:

```
conda install stone
```

It is possible to list all of the versions of `stone` available on your platform with:
